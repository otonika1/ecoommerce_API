...
public class CarouselController {
    ...
    public CarouselEntity updateCarousel(@PathVariable Long id,@RequestBody CarouselEntity carouselEntity) throws Exception {
        return  carouselService.updateCarousel(id,carouselEntity);
    }
